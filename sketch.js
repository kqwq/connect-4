...
function checkWin() {
  ...
  for (let i = 0; i < arr.length; i++) {
    for (let j = 0; j <= arr[i].length - 4; j++) {
      let val = arr[i][j]
      if (val && val == arr[i][j + 1] && val == arr[i][j + 2] && val == arr[i][j + 3]) {// If same color
        return val
      }
    }
  } 
  ...
  for (let i = 0; i <= arr.length - 4; i++) {
    for (let j = 0; j < arr[i].length; j++) {
      let val = arr[i][j]
      if (val && val == arr[1 + i][j] && val == arr[2 + i][j] && val == arr[3 + i][j]) {// If same color
        return val
      }
    }
  }
  ...
  for (let i = 0; i <= arr.length - 4; i++) {
    for (let j = 0; j <= arr[i].length - 4; j++) {
      let val = arr[i][j]
      if (val && val == arr[1 + i][1 + j] && val == arr[2 + i][2 + j] && val == arr[3 + i][3 + j]) {// If same color
        return val
      }
      val = arr[i][j + 3]
      if (val && val == arr[1 + i][j + 3 - 1] && val == arr[2 + i][j + 3 - 2] && val == arr[3 + i][j + 3 - 3]) {// If same color
        return val
      }
    }
  }
